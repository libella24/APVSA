...
namespace WIFI\apvsa\Jobify\Class\Subclass; //in diesem Verzeichnis liegt diese Datei "RowAbstract" drinnen
use WIFI\apvsa\Jobify\Mysql; // die Klasse Mysql wird in dieser Datei verwendet und muss daher geused werden.
